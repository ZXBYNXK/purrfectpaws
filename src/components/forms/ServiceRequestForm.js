...
const ServiceRequestForm = ({form=true, handleChange, props}) => {
    const inputs = (            
        <div className="form-content">
            ...
            <select name="subject" onChange={handleChange} value={props.subject}>
            ...
            <input name="startDate" type="date" value={props.startDate} onChange={handleChange} /> <br />
            <span>Day of Service / Service End Date</span> <br />
            <input name="endDate" type="date" value={props.endDate} onChange={handleChange} /> <br />
            <span>Message / Comments</span><br />
            <textarea name="message" type="text" value={props.message} onChange={handleChange}></textarea>
        </div>
);
    return form ? (
        <form className="form">
